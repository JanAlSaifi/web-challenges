...
copyInUppercaseButton.addEventListener("click", () => {
  const temp = firstCopyInUppercaseInput.value;
  secondCopyInUppercaseInput.value = temp.toUpperCase();
});
// --^-- End of Task 2 --^--
...
switchValueButton.addEventListener("click", () => {
  const switchValue = firstSwitchValueInput.value;
  firstSwitchValueInput.value = secondSwitchValueInput.value;
  secondSwitchValueInput.value = switchValue;
});
// --^-- End of Task 3 --^--
